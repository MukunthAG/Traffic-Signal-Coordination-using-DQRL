...
def run_simul():
    ...
    while tr.simulation.getMinExpectedNumber() > 0:
        ...
        # pp.pprint(tr.lane.getLastStepVehicleNumber("-1_2"))
        # pp.pprint(tr.lane.getWaitingTime("-1_2"))
        # pp.pprint(tr.trafficlight.getControlledLinks("TJ2"))
